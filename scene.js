...
const params = {
  ...
  causticColor: '#00ffcc',
  floorColor: '#152535',
  floorGroutColor: '#05101f',
  bigSphereEmissiveColor: '#00ffee',
  bigSphereEmissiveIntensity: 8,
  fresnelBias: 0.1,
  fresnelPower: 2.0,
  fresnelScale: 1.0,
  floorTileSize: 0.4,
...
try {
  ...
  msg.style.cssText = 'position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:rgba(0,20,40,0.95);color:#00ffcc;padding:2rem 3rem;z-index:10000;font-family:"Space Grotesk",sans-serif;border-radius:12px;text-align:center;max-width:400px;border:1px solid rgba(0,255,204,0.2);';
  msg.innerHTML = '<h2 style="margin-bottom:1rem;font-size:1.2rem;">WebGPU Required</h2><p style="font-size:0.9rem;color:#a0c0e0;line-height:1.6;">This experience requires a WebGPU-compatible browser.<br>Try Chrome 113+, Edge 113+, or Firefox Nightly.</p>';
...
const line1 = createCenteredText('Enkare', textLineHeight)
const line2 = createCenteredText('Nyrobi', 0)
...
// ─── Stats ──────────────────────────────────────────────────────────────────
const stats = new Stats({ trackGPU: false, trackCPT: true })
